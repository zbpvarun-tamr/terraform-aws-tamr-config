...
module "rds-postgres" {
  source = "git::git@github.com:Datatamer/terraform-aws-rds-postgres.git?ref=2.1.0"
...
module "sg-ports-rds" {
  source = "git::https://github.com/Datatamer/terraform-aws-rds-postgres.git//modules/rds-postgres-ports?ref=2.1.0"
}
